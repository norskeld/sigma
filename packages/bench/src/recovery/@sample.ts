...
/** Every Nth statement is malformed in the broken sample. */
export const BROKEN_EVERY = 20

export const BROKEN_COUNT: number = Math.floor((COUNT - 1) / BROKEN_EVERY) + 1
...
/**
 * The malformed element sits *before* the inner group, so resynchronising on the first `)` lands
