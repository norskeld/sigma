...
import { snippetMetadataPlugin } from './plugins/snippet-metadata'
import { createTypeScriptTransformer } from './transformers/typescript'
...
function getMarkdownConfig(): MarkdownOptions {
  return {
    ...
    config: (md: MarkdownIt) => {
      // Add our custom snippet metadata plugin
      md.use(snippetMetadataPlugin)
    },
    codeTransformers: [createTypeScriptTransformer()]
  }
}
